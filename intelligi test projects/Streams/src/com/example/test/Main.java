...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        Map<Integer , List<Employee>> groupedByAge = departments.stream().flatMap(department -> department.getEmployees().stream()).collect(Collectors.groupingBy(employee->employee.getAge()));
